...
impl serde::Serialize for EqualityNullBehavior {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for EqualityNullBehavior {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = EqualityNullBehavior;
            ...
            {
                match value {
                    "NULL_EQUALS_NOTHING" => Ok(EqualityNullBehavior::NullEqualsNothing),
                    "NULL_EQUALS_NULL" => Ok(EqualityNullBehavior::NullEqualsNull),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
